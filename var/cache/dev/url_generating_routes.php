...
return [
    ...
    'adminticket' => [['id'], ['_controller' => 'App\\Controller\\MainController::adminticket'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/adminticket']], [], []],
    'serviceticket' => [['id'], ['_controller' => 'App\\Controller\\MainController::serviceticket'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/serviceticket']], [], []],
